...
>(({ className, children, ...props }, ref) => (
  <Trigger
    className={cn(
      'flex h-9 w-fit items-center justify-center whitespace-nowrap rounded-md bg-transparent px-3 py-2 text-sm ring-offset-background hover:bg-accent hover:text-accent-foreground focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 data-[placeholder]:text-muted-foreground [&>span]:line-clamp-1',
      className
    )}
    ref={ref}
    {...props}
